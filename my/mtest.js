window.onload=function(){
	$Mcss();
	$A($Ca("span",{color:"blue",backgroundColor:"#aaa",padding:"1px 10px"},{"class":"wrapper"},"hello"));
}
...
function $TipCase(option){
    ...
    let mctt,ztbox,mcov;
    ztbox=$Ca("a",{"display":"block","color":"#fff","backgroundColor":"#222","padding":"10px 16px 10px 16px","borderRadius":"4px"},{"id":"ztbox"+eid,"class":"ztbox"});
...
function show_detail(dtl, ibg){
  let dh, dw;
  switch(ibg){case 1:dh="300px";dw="500px";break;case 2:dh="350px";dw="600px";break;case 3:dh="400px";dw="700px";break;case 4:dh="450px";dw="800px";break;default:dh="220px";dw="330px";}
